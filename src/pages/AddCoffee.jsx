  ...
  return (
    <div
      ...
      <div className="min-h-screen md:w-3/4 mx-auto py-6">
        ...
        <div>
          <form className="bg-[#F4F3F0] py-14 md:px-20 my-11 px-2 rounded-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <input
                type="submit"
                className=" py-2 px-4 bg-primary text-secondery font-rancho text-2xl rounded-md border-2 border-secondery md:col-span-2"
                value="Add Coffee"
              />
            </div>
          </form>
